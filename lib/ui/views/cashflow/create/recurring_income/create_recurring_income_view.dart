...
class CreateRecurringIncomeView extends StatelessWidget {
  const CreateRecurringIncomeView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CreateRecurringIncomeViewModel>.reactive(
      ...
      viewModelBuilder: () => CreateRecurringIncomeViewModel(),
    );
  }
}

class CreateRecurringIncomeViewModel extends BaseViewModel {
  ...
  onSubmit() {
    ...
    RecurringIncome ri = RecurringIncome(
    ...
    _cashflowCreateService.addTableEntry(
        value: ri, type: TableEntryType.recurringIncome);
