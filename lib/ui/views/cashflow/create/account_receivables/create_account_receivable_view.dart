...
class CreateAccountReceivableView extends StatelessWidget {
  const CreateAccountReceivableView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CreateAccountReceivableViewModel>.reactive(
      ...
      viewModelBuilder: () => CreateAccountReceivableViewModel(),
    );
  }
}

class CreateAccountReceivableViewModel extends BaseViewModel {
  ...
  onSubmit() {
    ...
    AccountReceivable ar = AccountReceivable(
    ...
    _cashflowCreateService.addTableEntry(
        value: ar, type: TableEntryType.accountReceivable);
