...
class CreateBusinessExpenseView extends StatelessWidget {
  const CreateBusinessExpenseView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CreateBusinessExpenseViewModel>.reactive(
      ...
      viewModelBuilder: () => CreateBusinessExpenseViewModel(),
    );
  }
}

class CreateBusinessExpenseViewModel extends BaseViewModel {
  ...
  onSubmit() {
    ...
    BusinessExpense bi = BusinessExpense(
    ...
    _cashflowCreateService.addTableEntry(
        value: bi, type: TableEntryType.businessExpense);
