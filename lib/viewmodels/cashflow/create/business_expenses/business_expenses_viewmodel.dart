...
import 'package:mpg_mobile/ui/views/cashflow/create/business_expenses/create_business_expenses_view.dart';
import 'package:mpg_mobile/ui/widgets/table.dart';
import 'package:stacked/stacked.dart';

class BusinessExpensesViewModel extends BaseViewModel {
  ...
  List<AppTableRow> get rows {
    return _cashFlowCreateService.businessExpenses
  ...
  onAdd() async {
    await _dialogService.showDialog(
        ...
        content: const CreateBusinessExpenseView(),
