...
class AccountPayablesViewModel extends BaseViewModel {
  ...
  List<AppTableRow> get rows {
    double total = 0;
    List<AppTableRow> result = _cashFlowCreateService.accountPayables.map((e) {
      total += e.amount;
  ...
  onAdd() async {
    await _dialogService.showDialog(
        ...
        content: const CreateAccountPayableView(),
